...
\Large{
  \begin{tabu}{ c l r }
   \multirow{5}{1in}{\includegraphics[width=0.88in]{avatar}} & \scshape{Bao Rong} & {Python~}\progressbar{0.75} \\
    & \email{1600012979@pku.edu.cn} & {Scala~}\progressbar{0.5} \\
    & \phone{(+86) 135-818-01421} & {Linux~}\progressbar{0.7} \\}
  \end{tabu}
}
...
\begin{itemize}
  \item 1. Participated in part of the system development work, including environmental construction and post-operational maintenance
  \item 2. Undertake the strategic design work in the future
\end{itemize}
